...
export function showCommandPalette(initialMode = "") {
  ...
  const commands = [
      ...
      { id: "dev_tools_actions", label: "Developer Tools: Actions", icon: "developer_mode", action: () => eventBus.emit('ha:dev-tools', { tab: 'actions' }) },
      { id: "dev_tools_template", label: "Developer Tools: Template", icon: "developer_mode", action: () => eventBus.emit('ha:dev-tools', { tab: 'template' }) },
      { id: "dev_tools_states", label: "Developer Tools: States", icon: "developer_mode", action: () => eventBus.emit('ha:dev-tools', { tab: 'states' }) },
      { id: "dev_tools_config", label: "Developer Tools: Config", icon: "developer_mode", action: () => eventBus.emit('ha:dev-tools', { tab: 'config' }) },
